...
import se.sinetiq.example.application.provider.api.TemperatureApi;
import se.sinetiq.example.application.provider.model.HistoricalTemperatureData;
import se.sinetiq.example.application.provider.model.TemperatureData;
